      ...
      def fetch_by_id(id, options={})
        ...
        record = if IdentityCache.should_use_cache?
          require_if_necessary do
            ...
            IdentityCache.logger.error "[IDC id mismatch] fetch_by_id_requested=#{id} fetch_by_id_got=#{object.id} for #{object.inspect[(0..100)]} " if object && object.id.to_s != id.to_s
            object
          end
        else
